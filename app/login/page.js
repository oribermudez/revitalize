...
const Login = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2">
      <div className="flex justify-center items-center bg-relax bg-cover h-full w-full">
      </div>
      <div className="md:min-h-screen flex items-center justify-center bg-[#f4f8f7] text-slate-900">
